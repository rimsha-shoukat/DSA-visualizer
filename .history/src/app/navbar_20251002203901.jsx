...
export default function navbar() {
    ...
    return (
        ...
        <div className="w-auto h-auto shadow-sm rounded-l-full px-4 py-1 flex flex-row items-center justify-center gap-4 bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
            ...
            <div className={`max-[580px]:absolute max-[580px]:top-16 max-[580px]:right-4 max-[580px]:flex max-[580px]:flex-col max-[580px]:items-end max-[580px]:justify-center max-[580px]:bg-[#d9d9d9]/90 dark:max-[580px]:bg-[#2a3b4d]/90 max-[580px]:backdro  flex flex-row items-center justify-center gap-4`}>
