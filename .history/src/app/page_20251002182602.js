...
export default function Home() {
  ...
  return (
    <div className="w-[100%] h-[100%] transition-all duration-300 bg-gradient-to-b from-white via-indigo to-violet-600 dark:bg-gradient-to-bl dark:from-gray-800 dark:via-blue-700 dark:to-gray-900">
