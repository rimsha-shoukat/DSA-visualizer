    ...
    <div className="w-[100%] h-[100%] transition-all duration-300">
      ...
      <div className="w-[100%] h-auto flex flex-col items-center justify-center gap-12 mt-[6rem]">
        <div className="flex flex-col items-start justify-start">
          ...
          <h1 className="text-[4rem] max-[540px]:text-[3rem] max-[390px]: font-semibold">Data Structure </h1>
          <h1 className="text-[4rem] max-[540px]:text-[3rem] max-[390px]: font-semibold">& algorithms</h1>
        </div>
