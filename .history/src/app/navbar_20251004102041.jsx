...
export default function navbar() {
    ...
    return (
        <div className="w-auto h-auto shadow-sm rounded-l-full max-[580px]:absolute max-[580px]:l pr-2 flex flex-row items-center justify-center bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
