...
export default function navbar() {
    ...
    return (
        ...
        <div className="w-auto h-auto shadow-sm rounded-l-full px-4 py-1 flex flex-row items-center justify-center gap-2 bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
            <Button onClick={ () => setViewNav(!viewNav) } variant="secondary" size="icon" className="size-sm bg-transparent hidden max-[580px]:block">
                <ChevronRightIcon />
            </Button>
            <div className={`transition-all duration-300 ${viewNav ? 'max-[580px]:flex' : 'max-[580px]:hidden' } flex flex-row items-center justify-center gap-4`}>
