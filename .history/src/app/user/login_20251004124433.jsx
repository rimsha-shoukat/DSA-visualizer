    ...
    return (
        <div className="absolute top-0 right-0 w-[100%] h-[100%] flex justify-center items-center">
            <div className="w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md inset-0 bg-white/30 rounded-md">
                ...
                <input className="rounded-full w-[100%] px-4 py-2 border-none bg- placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800" type="email" placeholder="Email" />
                <input className="rounded-full w-[100%] px-4 py-2 border-none bg- placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800" type="password" placeholder="Password" />
