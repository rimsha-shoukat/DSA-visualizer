        ...
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-6">
                ...
                <div className="flex flex-row items-center justify-between w-[100%] gap-2">
                    <input className="rounded-sm px-2 py-[0.2rem] w-[47%] text-sm border-none ring-2 ring-gray-300 shadow-md placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800"
                    type="text" disabled
                    defaultValue="admin" />
                    <input className="rounded-sm px-2 py-[0.2rem] w-[47%] text-sm border-none ring-2 ring-gray-300 shadow-md placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800"
                    type="email" disabled
                ...
                <div className="flex flex-row items-center justify-between gap-2">
                 ...
                 } className="bg-red-700 dark:bg-red-700 dark:hover:bg-red-900 px-4 py-2" variant="outline">Logout</Button>
                 <Button  onClick={() =>
                    toast.success("Account deleted successfully")
                 } className="hover:bg-red-700 dark:hover:bg-red-700 px-4 py-2" variant="outline">Logout</Button>
                </div>
            </div>
        </>
    )
