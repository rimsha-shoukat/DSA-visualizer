...
export default function Signup({ setLog, setSign }) {
    ...
    const handleFormSubmission = () => {
        ...
        let invalidUser = users.find(user => user.email === email);
    ...
    return (
        <>
            ...
            <form onSubmit={ () => handleFormSubmission } className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[24rem] max-[470px]:w-[18rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md bg-white/30 rounded-md">
