...
export default function login({ setLog, setSign }) {
    ...
    return (
        <>
            <div onClick={() => { setSign(false); setLog(false); setB }} className="w-[100%] h-[100%] absolute top-0 left-0 backdrop-blur-md inset-0 transition-all duration-300 flex items-center justify-center">
            </div>
