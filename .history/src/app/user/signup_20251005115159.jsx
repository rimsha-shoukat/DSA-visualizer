...
export default function Signup({setLog, setSign}){
    ...
    return (
        <div onClick={()=> { setSign(false); setLog(false); }} className="w-[100%] h-[100%] backdrop-blur-md inset-0 absolute top-0 left-0 transition-all duration-300 flex items-center justify-center">
        </div>
            <div className="w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md bg-white/30 rounded-md">
