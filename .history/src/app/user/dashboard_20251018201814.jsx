        ...
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-6 flex flex-col gap-6">
                ...
                <div className="flex flex-row items-center justify-between gap-2">
                 ...
                 } className="bg-red-700 dark:bg-red-700 px-4 py-2 transition-all duration-300" variant="outline">Logout</Button>
                 <Button  onClick={() =>
                    toast.success("Account deleted successfully")
                 } className="hover:bg-red-700 dark:hover:bg-red-700 px-4 py-2 transition-all duration-300" variant="outline">Delete Account</Button>
                </div>
            </div>
        </>
    )
