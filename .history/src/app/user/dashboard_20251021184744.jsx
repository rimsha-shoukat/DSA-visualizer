        ...
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-6 flex flex-col gap-6">
                ...
                <div className="flex flex-row items-center justify-between gap-2">
                    <button className="rounded-md bg-blue-800 hover:shadow-md font-semibold py-2 px-4">Logout</button>
                    <button className="rounded-md bg-red-600 hover:shadow-md font-semibold py-2 px-4">Delete Account</button>
                </div>
            </div>
        </>
    )
