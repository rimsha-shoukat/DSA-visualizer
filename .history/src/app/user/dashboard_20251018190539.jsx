        ...
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-6">
                ...
                <div className="flex flex-row items-center justify-between w-[100%] gap-4">
                    npm dlx shadcn@latest add input-group
                    <Input disabled className="bg-gray-800/30 dark:bg-gray-800/30 shadow-sm py-4" type="email" defaultValue="admin@gmail.com" />
                </div>
                <div className="w-[100%] h-[5rem] text-blue-500 shadow-sm p-4 rounded-md">Analytics graph will be there</div>
                <Button  onClick={() =>
