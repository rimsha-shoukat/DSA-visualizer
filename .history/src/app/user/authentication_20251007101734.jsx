...
export async function SignAuth({name, email, pass, setEmailError, setUserError, setPassError, setLog, setSign}){
...
export async function LogAuth({email, pass, setEmailError, setPassError, setUserError, setLog, setSign}){
    const usersCollection = await getCollection('users');
    console.log(usersCollection);
    let validEmail = validator.isEmail(email);
