...
export default function Dashboard({setBoard}){
    return(
        <>
            ...
            <div className="w-[30rem] h-auto top-1/2 left-1/5 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-4">
                ...
                <Button className="bg-red-800" size="icon" variant="outline">Logout</Button>
            </div>
        </>
    )
}