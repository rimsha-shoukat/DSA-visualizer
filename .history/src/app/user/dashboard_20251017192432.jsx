        ...
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-row items-center justify-between w-[100%]">
                    <input
                    className="w-[50%] px-4 py-2 border-none ring-2 ring-gray-300 placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800"
                    required
                    type="text"
                    placeholder="Name"
                />
                <input
                    className="w-[50%] px-4 py-2 border-none ring-0 placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800"
                    required
                    type="email"
                    placeholder="Email"
                />
                ...
                <Button className="bg-red-800 px-4 py-2" variant="outline">Logout</Button>
            </div>
        </>
    )
}