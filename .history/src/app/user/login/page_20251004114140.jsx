    ...
    return (
        <div className="w-[100%] h-[100%] flex justify-center items-center">
            <div className="w-auto h-auto flex flex-col items-center justify-center p-6 backdrop-blur-md inset-0 bg-white/30 rounded-md">
                ...
                <input className="rounded-lg w-[12rem] px-4 py-2 " type="email" placeholder="Email" />
                <input className="rounded-lg w-[12rem] px-4 py-2 " type="password" placeholder="Password" />
                <button>LOGIN</button>
                <div>
                    <p>Forgot Password?</p>
                    <p>Sign Up</p>
