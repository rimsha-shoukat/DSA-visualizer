    ...
    return (
        <div className="w-[100%] h-[100%] flex justify-center items-center">
            <div className="w-[24rem] h-auto flex flex-col gap-2 items-center justify-center p-6 backdrop-blur-md inset-0 bg-white/30 rounded-md">
                ...
                <input className="rounded-full w-[ px-4 py-2 border-2 border-gray-300 focus:outline-none" type="email" placeholder="Email" />
                <input className="rounded-full w-[ px-4 py-2 border-2 border-gray-300 focus:outline-none" type="password" placeholder="Password" />
