    ...
    return (
        <div className="w-[100%] h-[100%] flex justify-center items-center">
            <div className="w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md inset-0 bg-white/30 rounded-md">
                ...
                <h1 className="text-[1.5rem] w-[100%] border-t-2 border-gray-200">OR</h1>
                <div className="w-[100%] flex flex-row items-center justify-evenly">
                    <button className="w-[2rem] h-auto p-2 bg-gray-600 rounded-full">
                        <FcGoogle/>
                    </button>
                    <button className="w-auto h-auto p-2 bg-gray-600 rounded-full">
                        <SiLinkedin/>
                    </button>
                    <button className="w-auto h-auto p-2 bg-gary-600 rounded-full">
                        <FaGithub/>
                    </button>
                </div>
            </div>
