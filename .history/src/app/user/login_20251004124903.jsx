...
export default function login(){
    return (
        <div className=" w-[100%] h-[100%] flex justify-center items-center">
            <div className="absolute top-0 right-0w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md inset-0 bg-white/30 rounded-md">
