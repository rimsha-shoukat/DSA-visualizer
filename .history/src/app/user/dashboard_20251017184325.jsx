...
export default function Dashboard({setBoard}){
    return(
        <>
            ...
            <div className="w-[30rem] h-[30rem] top-1/5 left-1/5 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-">
                <h1 className="text-[2rem] text-blue-800 font-bold">DASHBOARD</h1>
                <div className="flex flex-row items-center justify-center w-[100%]"></div>
