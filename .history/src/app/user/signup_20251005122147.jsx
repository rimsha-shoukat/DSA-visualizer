...
export default function Signup({setLog, setSign}){
    ...
    return (
        <>
            ...
            <form type='Submit' className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md bg-white/30 rounded-md">
                        ...
                        <button onSubmit={ (e) => handleFormSubmission(e) } className="rounded-full w-[100%] bg-blue-800 hover:shadow-md font-semibold py-2 mt-4">SIGNUP</button>
