        ...
        <>
            ...
            <div className="w-[30rem] h-auto top-1/5 left-1/5 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-row items-center justify-center w-[100%]">
                    <input
                    className="rounded-full w-[10%] px-4 py-2 border-none ring-2 ring-gray-300 placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800"
                    required
                    type="text"
                    placeholder="Name"
                />
