...
export default function Dashboard({setBoard}){
    return(
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-">
                ...
                <div className="flex flex-row items-center justify-between w-[100%] gap-4">
                    <Input className="bg-gray-300 shadow-sm" type="text" placeholder="Name" />
                    <Input className="bg-gray-300 shadow-sm" type="email" placeholder="Email" />
                </div>
                <div className="w-[100%] h-[5rem] border-2 border-blue-800 p-4 rounded-sm">No Analytics yet!</div>
                <Button  onClick={() =>
