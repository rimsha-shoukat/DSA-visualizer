...
export default function Signup({setLog, setSign}){
    ...
    return (
        <div className="w-[100%] h-[100%] backdrop-blur-md inset-0 absolute top-1/2 left-1/2">
            <div className=" transition-all duration-300 w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md bg-white/30 rounded-md">
