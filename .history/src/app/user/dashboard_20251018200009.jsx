        ...
        <>
            ...
            <div className="w-[30rem] h-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4 flex flex-col gap-6">
                ...
                <div className="flex flex-col items-center justify-between w-[100%] gap-2">
                    ...
                    type="text"
                    defaultValue="admin" />
                    <input className="rounded-sm px-2 w-[] border-none ring-2 ring-gray-300 shadow-md placeholder-gray-700 focus:outline-none focus:border-none focus:ring-2 focus:ring-blue-800"
                    type="email"
