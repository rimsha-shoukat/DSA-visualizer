...
export default function login(){
    return (
            <div className="absolute top-50 left-50 translate- w-[24rem] h-auto flex flex-col gap-4 items-center justify-center p-6 backdrop-blur-md inset-0 bg-white/30 rounded-md">
