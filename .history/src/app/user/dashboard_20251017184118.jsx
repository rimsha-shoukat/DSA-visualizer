...
export default function Dashboard({setBoard}){
    return(
        <>
            ...
            <div className="w-[30rem] h-[30rem] top-1/5 left-1/5 -translate-x-1/2 -translate-y-1/2 bg-white/30 rounded-md backdrop-blur-md p-4">
                <h1 className="text-[2rem] text-blue-800 font-bold">DASHBOARD</h1>
                <p className="text-[1rem] text-gray-700">Welcome to your dashboard!</p>
            </div>
        </>
    )
}