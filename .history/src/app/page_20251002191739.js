...
export default function Home() {
  ...
  return (
    <div className="w-[100%] h-[100%] transition-all duration-300 ">
      <div className="w-[100%] h-auto flex flex-row items-center justify-between py- pl-3">
        <h1 className="text-4vw text-[#2962ff] font-semibold">DSAvisualizer</h1>
        <Navbar/>
      </div>
      <div className="w-[100%] h-auto flex flex-col items-center justify-center gap-12 mt-20">
        <div className="flex flex-col items-start justify-start">
          ...
          <h1 className="text-[4rem] font-semibold leading-14">& algorithms</h1>
        </div>
