...
export default function navbar() {
    ...
    return (
        <div className="w-auto h-auto text-[1rem] shadow-md rounded-l-full px-3 max-[390px]:gap-0 gap-4 flex flex-row items-center justify-center bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
