  ...
  return (
    <div className="w-[100%] h-[100%] transition-all duration-300">
      <div className="w-[100%] h-auto flex flex-row items-center justify-between py-4 pl-3">
        <h1 className="text:clamp(0.8rem, 6vw, 2rem) text-[#2962ff] font-semibold">DSAvisualizer</h1>
        <Navbar/>
      </div>
      <div className="w-[100%] h-auto flex flex-col items-center justify-center gap-12 mt-[6rem]">
        <div className="flex flex-col items-start justify-start">
          ...
          <h1 className="text:clamp(2rem, 10vw, 6rem) font-semibold">Data Structure </h1>
          <h1 className="text-[clamp(3rem, 10vw, 6rem)] font-semibold">& algorithms</h1>
        </div>
