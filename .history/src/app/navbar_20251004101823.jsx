...
export default function navbar() {
    ...
    return (
        <div className="w-auto h-auto shadow-sm rounded-l-full pr-2 flex flex-row items-center justify-center bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
            ...
            <div className={`transition-all duration-300 ${viewNav ? 'max-[580px]:flex' : 'max-[580px]:hidden' } max-[580px]:ab flex flex-row items-center justify-center px-2 py-1 gap-4`}>
