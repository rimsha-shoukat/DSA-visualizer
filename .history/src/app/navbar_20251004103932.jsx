...
export default function navbar() {
    ...
    return (
        <div className="w-auto h-auto shadow-sm rounded-l-full px-3 max-[390px]:text-sm max-[390px]: gap-4 py-1 flex flex-row items-center justify-center bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
