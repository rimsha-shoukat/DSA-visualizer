...
export default function topicsList({setList}){
    return (
        <>
            ...
            <Searchbar/>
            <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 backdrop-blur-md p-4 bg-white/30 transition-all  border-2 border-blue-900">hello</h1>
        </>
    )
}