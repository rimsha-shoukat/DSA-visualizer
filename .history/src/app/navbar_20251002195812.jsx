...
export default function navbar() {
    return (
        <div className="w-auto h-auto max-[580px]:hidd shadow-sm rounded-l-full px-4 py-1 flex flex-row items-center justify-center gap-4 bg-[#d9d9d9]/50 dark:bg-[#2a3b4d]/50">
