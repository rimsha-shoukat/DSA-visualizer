...
export default function Home() {
  ...
  return (
    <div className="w-[100%] h-[100%] transition-all duration-300">
      ...
      <div className="w-[100%] h-[80vh] flex flex-col items-center justify-center gap-10">
        <div className="flex flex-col items-start justify-start">
          <h2 className="text-[#2962ff] leading-2 font-semibold">Learn & practice</h2>
          <h1 className="text-[3.5rem] font-semibold leading-6">Data Structure <br/> & algorithms</h1>
        </div>
