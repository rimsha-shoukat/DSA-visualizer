...
import { connectDB, User } from '@/database';  // Adjust path if needed (e.g., '../../../database')
import { NextResponse } from 'next/server';
import bcrypt from 'bcrypt';
import Joi from 'joi';  // For validation (you installed it)

// Joi schema for robust validation
...
export async function POST(request) {
  try {
    ...
    // Early checks for missing fields
